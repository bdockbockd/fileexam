...
public class CinemaComplex {
	...
	public void handleBookingProcess() {
		...
		Ticket t = new Ticket(theater.getTheaterNumber(), movieName, startTimeSlot, row, column);
		tickets.add(t);
	...
	public boolean handleBookingProcess(int theaterNumber, String movieName, int startTimeSlot, int row, int column) {
		...
		/// create a ticket object & add it to tickets arraylist here ///
		if(bookingSuccess) {
			Ticket t = new Ticket(theaterNumber, movieName, startTimeSlot, row, column);
			tickets.add(t);			
		}
		/////////////////////////////////////////////////////////////////
	...
	public void showAllTickets() {
		for(Ticket ticket:tickets) {
			System.out.print("Theater: " + ticket.getNumber() + ", ");
			System.out.print("Movie: " + ticket.getName() + ", ");
			System.out.print("Time: " + ticket.getStart() + ", ");
			System.out.println("Seat: " + ticket.getRow() + "/" + ticket.getColumn());
		}
	}
